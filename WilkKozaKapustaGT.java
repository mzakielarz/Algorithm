...
class Stan implements Cloneable
{
  ...
  final static int MAX_DLUGOSC_DROGI = 10;
  final static int minDlugoscDrogi = MAX_DLUGOSC_DROGI;
  private static Stan[] droga = new Stan[MAX_DLUGOSC_DROGI];
  private static Stan[] minDroga = new Stan[MAX_DLUGOSC_DROGI];
